<footer class="page-footer"><div class="footer-copyright"><div class="container"><span>&copy; <?php echo date('Y'); ?> DarkOrbit &middot; Beyond the limits</span><span><?php echo (int)Socket::Get('OnlineCount', array('Return' => 0)); ?> pilots online <span aria-hidden="true">&nbsp; / &nbsp;</span><a href="https://darkorbit.com/" target="_blank" rel="noopener">DarkOrbit &nearr;</a></span></div></div></footer>
...
<?php if (Functions::IsLoggedIn() && $page[0] === 'equipment') { ?>
  ...
  <script type='text/javascript'>
      function onFailFlashembed() {
        ...
        html += '<div class="flashFailHead">Your loadout awaits.</div>';
        html += '<div class="flashFailHeadText">';
        html += 'Open Equipment in the Windows game client to configure your ship, drones and equipment.';
        html += '<div class="flashFailHeadLink">';
        html += '<a class="orbit-button" href="/downloads/DarkOrbit-Client.zip" download>Download Windows client &darr;<\/a>';
        html += '</div>';
        html += '</div>';
        html += '</div>';
