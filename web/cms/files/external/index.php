      <div id="main" class="index">
        <div class="container container-center">
          <section class="orbit-landing-copy">
            <span class="orbit-eyebrow"><span class="orbit-status-dot"></span> YOUR UNIVERSE AWAITS</span>
            <h1>Beyond the stars.<br><span>Above the rest.</span></h1>
            <p>Take command of your own starship. Find your allies, build your fleet and leave your mark on the galaxy.</p>
            <div class="orbit-landing-art"><img src="/do_img/global/items/ship/goliath_top.png" alt="Goliath battlecruiser"><span>GOLIATH / BATTLECRUISER CLASS</span></div>
            <div class="orbit-landing-features"><div><strong>Choose your side</strong><small>Three rival corporations</small></div><div><strong>Build your legacy</strong><small>One shared universe</small></div><div><strong>Fly together</strong><small>Stronger as a clan</small></div></div>
          </section>
          <div class="row form">
            <div class="col l6 s12 offset-l3">
              <div class="card">
                <div class="orbit-login-intro"><span class="orbit-eyebrow">PILOT ACCESS</span><h2>Welcome to the orbit.</h2><p>Your next adventure is one launch away.</p></div>
