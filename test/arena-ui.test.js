...
test('1v1 overlay supports nickname invite, polling, accept and decline', () => {
  ...
  for (const action of ['invite', 'poll', 'accept', 'decline']) assert.match(script, new RegExp(`['\"]${action}['\"]`));
