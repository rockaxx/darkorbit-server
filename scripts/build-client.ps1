...
foreach ($file in @('client-transport.js','client-tabs.html','client-tabs.js','client-tabs-preload.js')) {
...
Set-Content (Join-Path $stage 'Start-Client.cmd') @('@echo off', 'start "" "%~dp0runtime\electron.exe" "%~dp0public-client.js"')
