...
foreach ($file in @('client-transport.js','flash-display-mode.js','client-zoom.js','game-zoom-preload.js','client-port-guard.ps1','Start-Client.ps1','client-tabs.html','client-tabs.js','client-tabs-preload.js')) {
